  ...
  const getOption = (i: number, camera: CameraKind, device: DeviceInfo) => {
    return (
      <input
        ...
        checked={
          device.deviceId ==
          (camera === "main" ? mainCameraDevice : smallCameraDevice)?.deviceId
        }
        data-focusable="true"
        onInput={() => {
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th data-for="camera" id="device-select-main-camera-label">
                    Main Camera
                  </th>
                  {hasMultipleDevices ? (
                    <th data-for="camera" id="device-select-small-camera-label">
                      Small Camera
                    </th>
                  ) : (
                    <></>
              ...
              <tbody>
                {devices.map((device: DeviceInfo, i: number) => {
                  return (
                    <tr key={`device-select-device-row-${i.toString()}`}>
                      <td
                        data-for="device"
                      ...
                      <td data-for="camera">{getOption(i, "main", device)}</td>
                      {hasMultipleDevices ? (
                        <td data-for="camera">
